...
class BlocksTable:
    ...
    def write_blocks(conn: Connection[TupleRow]) -> None:
        ...
        blocks = [
            (1, 1, 1, {"question_content": "what is the colour of the sky?", "question_answer": "blue"}),
            ...
            (2, 1, 1, {"question_content": "what is the colour of the grass?", "question_answer": "green"}),
            ...
            (3, 1, 1, {"question_content": "what is the colour of the sea?", "question_answer": "blue"}),
            ...
            (4, 1, 1, {"question_content": "what is the colour of the sun?", "question_answer": "yellow"}),
    ...
    @staticmethod
    def get_blocks(service: Connection[TupleRow], lesson_id: int) -> list[tuple[int, int, str]]:
